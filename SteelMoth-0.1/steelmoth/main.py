...
def main():
    ...
    wcolcm = WidgetColumnConfigureManager(udm, wtm, wcolf, column=1, row=0, sticky=N+W+E+S)
    ...
    wrowcm = WidgetRowConfigureManager(udm, wtm, wrowf, column=1, row=0, sticky=N+W+E+S)
